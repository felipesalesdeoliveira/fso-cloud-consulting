...
export function Contact() {
  return (
    <section id="contato" className="scroll-mt-24 bg-white px-6 py-24">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[36px] bg-[#101C3C] p-8 text-white shadow-[0_30px_90px_rgba(15,23,42,0.22)] md:p-14">
        ...
        <div className="relative grid gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-blue-300">Contato</p>
            <h2 className="mt-5 max-w-2xl text-3xl font-bold leading-[1.1] tracking-[-0.035em] md:text-5xl">
              Sua infraestrutura está preparada para crescer com confiabilidade?
            </h2>
          ...
          <form className="grid gap-4 rounded-3xl border border-white/10 bg-white/[0.06] p-6 backdrop-blur-xl md:p-8">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="name" className="mb-2 block text-sm font-medium text-slate-300">Nome</label>
                <input id="name" name="name" type="text" className="w-full rounded-xl border border-white/15 bg-white/[0.08] px-4 py-3.5 text-white outline-none transition focus:border-blue-300 focus:bg-white/[0.12]" />
              </div>
              <div>
                <label htmlFor="company" className="mb-2 block text-sm font-medium text-slate-300">Empresa</label>
                <input id="company" name="company" type="text" className="w-full rounded-xl border border-white/15 bg-white/[0.08] px-4 py-3.5 text-white outline-none transition focus:border-blue-300 focus:bg-white/[0.12]" />
              </div>
            </div>
            <div>
              <label htmlFor="email" className="mb-2 block text-sm font-medium text-slate-300">E-mail</label>
              <input id="email" name="email" type="email" className="w-full rounded-xl border border-white/15 bg-white/[0.08] px-4 py-3.5 text-white outline-none transition focus:border-blue-300 focus:bg-white/[0.12]" />
            </div>
            <div>
              <label htmlFor="message" className="mb-2 block text-sm font-medium text-slate-300">Qual desafio você precisa resolver?</label>
              <textarea id="message" name="message" className="min-h-36 w-full resize-none rounded-xl border border-white/15 bg-white/[0.08] px-4 py-3.5 text-white outline-none transition focus:border-blue-300 focus:bg-white/[0.12]" />
            </div>
            <button type="button" className="mt-2 inline-flex items-center justify-center gap-3 rounded-xl bg-blue-600 px-6 py-4 font-bold text-white shadow-[0_14px_35px_rgba(37,99,235,0.28)] transition duration-300 hover:-translate-y-1 hover:bg-blue-500">
              Enviar mensagem
              <ArrowIcon />
            </button>
          </form>
